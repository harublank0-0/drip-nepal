  ...
  return (
    <div className="border-t border-border/50 pt-4 mt-4">
      ...
      >
        ...
        <ChevronDown
          className={`size-3.5 ml-auto transition-transform duration-200 ${isOpen ? 'rotate-180' : ''}`}
        />
      </button>
      ...
      {coupon && (
        <div className="flex items-center gap-2 mt-2 text-xs text-green-600 dark:text-green-400">
          ...
          <button
            ...
            className="ml-auto text-muted-foreground hover:text-foreground underline transition-colors"
          >
            Remove
          </button>
        </div>
