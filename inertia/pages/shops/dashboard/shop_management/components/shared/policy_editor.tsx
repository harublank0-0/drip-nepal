...
/**
 * A dependency-free "rich text" editor: a plain textarea paired with a
 * formatting toolbar that wraps the current selection in markdown-style
 * tokens. Keeps the bundle light while still giving vendors a familiar
 * writing surface with live character counting.
 */
